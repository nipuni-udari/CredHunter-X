...
class TestSessionCSRF:
    ...
    def test_detailed_expected_values(self):
        ...
        with TimePin.pin_time(dt(8, 11, 12)):
            ...
            assert token == "25320273898820##29764505m00czd7fg38107712t046dp812sjt0cc"
        ...
        with TimePin.pin_time(dt(8, 18)):
            ...
            assert (
                new_token == "71186239342684##y010v6g3g33311504237907i380589432mk41l38"
            )
        ...
        with TimePin.pin_time(dt(8, 44)):
            bad_token = "74978297533680##q584d9v5o87953822306444t154400894db42z20"
