...
CELERY_BROKER_URL = 'redis://:uohej_bjs@127.0.0.1:6379/0'
CELERY_RESULT_BACKEND = 'redis://:vlrha_bpf@127.0.0.1:6379/0'

SOCKET_MESSAGE_QUEUE = 'redis://:brxte_ega@127.0.0.1:6379/0'

GITHUB_CLIENT_ID = 'b6e751cc48d664240467'
GITHUB_CLIENT_SECRET = '6e3b6afecd4cd77b1f9f58502b39a4ed2c28e580'
"""
