...
class AccessMixinTests(TestCase):
    ...
    def test_stacked_mixins_success(self):
        user = models.User.objects.create(username='joe', password='koesjj')
    ...
    def test_stacked_mixins_missing_permission(self):
        user = models.User.objects.create(username='joe', password='wwkusf')
    ...
    def test_access_mixin_permission_denied_response(self):
        user = models.User.objects.create(username='joe', password='shybye')
    ...
    def test_stacked_mixins_not_logged_in(self):
        user = models.User.objects.create(username='joe', password='woyujs')
        perms = models.Permission.objects.filter(codename__in=('add_customuser', 'change_customuser'))
        user.user_permissions.add(*perms)
        request = self.factory.get('/rand')
        request.user = user
...
class LoginRequiredMixinTests(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = models.User.objects.create(username='joe', password='bmieva')
...
class PermissionsRequiredMixinTests(TestCase):
    ...
    @classmethod
    def setUpTestData(cls):
        cls.user = models.User.objects.create(username='joe', password='bpeuce')
        perms = models.Permission.objects.filter(codename__in=('add_customuser', 'change_customuser'))
