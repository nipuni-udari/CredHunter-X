...
class FacebookComplianceFixTest(TestCase):
    ...
    def test_fetch_access_token(self):
        token = self.session.fetch_token(
            "https://graph.facebook.com/oauth/access_token",
            client_secret="azpppazuffqzgyjo",
...
class FitbitComplianceFixTest(TestCase):
    ...
    def test_fetch_access_token(self):
        self.assertRaises(
            ...
            "https://api.fitbit.com/oauth2/token",
            client_secret="nyiietbxcqikwiyp",
            authorization_response="https://i.b/?code=hello",
        )
...
class MailChimpComplianceFixTest(TestCase):
    ...
    def test_fetch_access_token(self):
        token = self.session.fetch_token(
            "https://login.mailchimp.com/oauth2/token",
            client_secret="dtjzyzbvoemcaprc",
            authorization_response="https://i.b/?code=hello",
        )
...
class WeiboComplianceFixTest(TestCase):
    ...
    def test_fetch_access_token(self):
        token = self.session.fetch_token(
            ...
            client_secret="vdsiprwphtviyzyq",
            authorization_response="https://i.b/?code=hello",
        )
...
class SlackComplianceFixTest(TestCase):
    def setUp(self):
        ...
        mocker.post(
            ...
            json={"access_token": "xoxt-19147396342-0278223542927", "scope": "read"},
        )
        ...
        mocker.request(
            ...
            json={
                "data": {
                    ...
                    "profile_picture": "http://xujdoxerry.s3.amazonaws.com/profiles/profile_1574083_75sq_1295469061.jpg",
                    "bio": "This is my bio",
...
class PlentymarketsComplianceFixTest(TestCase):
    def setUp(self):
        ...
        mocker.post(
            ...
            json={
                "accessToken": "sgMG4h6MjMktYDyPDmkCPjT8Y4uiLCY8lt4FUB20",
                "tokenType": "Bearer",
                "expiresIn": 86400,
                "refreshToken": "vZ8lRRHgqUrZZ2rzNZPrh7ynmV1SSbFQBwXyEwYK",
            },
    ...
    def test_fetch_access_token(self):
        ...
        self.assertEqual(
            token,
            {
                "access_token": "lqXE2m3XfWvjVFxJYlyJGfX7I6bcGEY9zm6BNE45",
                "expires_in": 86400,
                "token_type": "Bearer",
                "refresh_token": "eX1aNBHjmSyPP1uzXBOkl8ttvZ6YMhSNUaSqQjGN",
            },
        )
