...
class Migration(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.migration.guid, "435ebafb-a391-56b5-3e13-1a7ae1cc11dc")
    ...
    def testGetArchiveUrlWhenExported(self):
        self.assertEqual(
            ...
            "https://ucucqo-vvhvh.s3.amazonaws.com/migration/25320/24575?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIABETWEXJZMMTIV5CV%2F50097442%2Fwh-dtku-5%2Fv0%2Fsri0_axoxqoe&X-Amz-Date=20180913T201100Z&X-Amz-Expires=300&X-Amz-Signature=a0aeb638facd0c78c1ed3ca86022eddbee91e5fe1bb48ee830f54b8b7b305026&X-Amz-SignedHeaders=host&actor_id=41840111&response-content-disposition=filename%3D145eebbd-a696-59d2-0a85-8b4fd3ce70fd.tar.gz&response-content-type=application%2Fx-gzip",
        )
