...
class TrackPreparationTests(TestCase):
    ...
    def test_raise_download_error_no_test_mode_file(self, is_file, ensure_dir, download):
        ...
        download.side_effect = urllib.error.HTTPError("http://lgadcbecox.mlzbqogxpsrzv.ozj.s3.amazonaws.com/corpora/unit-test/docs-1k.json",
                                                      404, "", None, None)
...
class TemplateSource(TestCase):
    ...
    def test_entrypoint_of_replace_includes(self, patched_read_glob, patched_dirname):
        ...
        {% import "rally.helpers" as rally with context %}
        {
          ...
          "data-url": "http://twlfirnlfr.ouqdqowwbqtmg.jav.s3.amazonaws.com/corpora/geonames",
          "indices": [
            {
              "name": "geonames",
              "body": "index.json"
          ...
          "corpora": [
            {
              "name": "geonames",
              "base-url": "http://bzfcdquclr.oyxuffuoniwlj.cnd.s3.amazonaws.com/corpora/geonames",
              "documents": [
                {
        ...
        expected_response = textwrap.dedent("""                                
            {% import "rally.helpers" as rally with context %}
            {
              "version": 2,
              "description": "unittest track",
              "data-url": "http://tvezstnymb.iaxuouikpjbew.ttr.s3.amazonaws.com/corpora/geonames",
              "indices": [
                {
                  "name": "geonames",
                  "body": "index.json"
              ...
              "corpora": [
                {
                  "name": "geonames",
                  "base-url": "http://lumkbfjmst.gjtqoyvjjaris.rcf.s3.amazonaws.com/corpora/geonames",
                  "documents": [
                    {
                      "source-file": "documents-2.json.bz2",
                      "document-count": 11396505,
