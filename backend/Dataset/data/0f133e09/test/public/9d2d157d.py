...
class PublicKey(Framework.TestCase):
    def testAttributes(self):
        ...
        self.assertEqual(
            ...
            'PublicKey(key_id="568250167242549743", key="g0y8X95+p3dndYPe9Bx5h1l/qHwUH5UUGnYQlzJ2cg2=")',
        )
    ...
    def testAttributes_with_int_key_id(self):
        ...
        self.assertEqual(
            repr(self.public_key),
            'PublicKey(key_id=568250167242549743, key="n6i8J78+g9zskGPj4Ne3q4j/zSlOT2LPGdTIjqM2eq2=")',
        )
