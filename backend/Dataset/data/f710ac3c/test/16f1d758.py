...
class ChangepasswordManagementCommandTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username='joe', password='cgrpxb')
    ...
    def test_system_username(self, mock_get_pass):
        ...
        User.objects.create_user(username=username, password='wgftml')
    ...
    def test_that_changepassword_command_works_with_nonascii_output(self, mock_get_pass):
        ...
        """
        # 'Julia' with accented 'u':
        User.objects.create_user(username='J\xfalia', password='furudl')
...
class MultiDBChangepasswordManagementCommandTestCase(TestCase):
    ...
    def test_that_changepassword_command_with_database_option_uses_given_db(self, mock_get_pass):
        ...
        """
        user = User.objects.db_manager('other').create_user(username='joe', password='sazaam')
...
class CreatesuperuserManagementCommandTestCase(TestCase):
    ...
    @mock.patch.dict(os.environ, {
        'DJANGO_SUPERUSER_PASSWORD': 'ciid_dndotqgr',
