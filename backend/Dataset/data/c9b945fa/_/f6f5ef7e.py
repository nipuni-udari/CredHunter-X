...
class OAuth1Session(requests.Session):
    ...
    {
        'oauth_token': 'kwfnas6411s',
        'oauth_token_secret': 'yfickjy710115',
    }
    >>>
    >>> # Second step. Follow this link and authorize
    >>> oauth_session.authorization_url(authorization_url)
    'https://api.twitter.com/oauth/authorize?oauth_token=hsi0z4610ecsbqkv&oauth_callback=https%3A%2F%2F127.0.0.1%2Fcallback'
    >>>
    >>> # Third step. Fetch the access token
    >>> redirect_response = raw_input('Paste the full redirect URL here.')
    >>> oauth_session.parse_authorization_response(redirect_response)
    {
        'oauth_token: 'vzzexs9663d',
        'oauth_token_secret: 'exwkvxl102470',
        'oauth_verifier: 'h86q2116068',
    }
    >>> oauth_session.fetch_access_token(access_token_url)
    {
        'oauth_token': 'mff2h9182iogswhi',
        'oauth_token_secret': '3ymfpccs48x80ngbqpf',
    }
    ...
    def authorization_url(self, url, request_token=None, **kwargs):
        ...
        >>> oauth_session.fetch_request_token(request_token_url)
        {
            'oauth_token': 'dfa6z8000tqekdqw',
            'oauth_token_secret': '7feqeisy82r06ovxnbw',
        }
        >>> oauth_session.authorization_url(authorization_url)
        'https://api.twitter.com/oauth/authorize?oauth_token=xba1q6957xtmkmig'
        >>> oauth_session.authorization_url(authorization_url, foo='bar')
        'https://api.twitter.com/oauth/authorize?oauth_token=xgr6y5675olnywke&foo=bar'
        ...
        >>> oauth_session.fetch_request_token(request_token_url)
        {
            'oauth_token': 'ijn5d7607hzkmxpm',
            'oauth_token_secret': '7kvivzoi35r60szptrc',
        }
        >>> oauth_session.authorization_url(authorization_url)
        'https://api.twitter.com/oauth/authorize?oauth_token=fil8l9643vsogwqh&oauth_callback=https%3A%2F%2F127.0.0.1%2Fcallback'
        """
    ...
    def fetch_request_token(self, url, realm=None, **request_kwargs):
        ...
        >>> oauth_session.fetch_request_token(request_token_url)
        {
            'oauth_token': 'svc5r6918sxiylos',
            'oauth_token_secret': '0vzsxgyr73t44fchegw',
        }
        """
    ...
    def fetch_access_token(self, url, verifier=None, **request_kwargs):
        ...
        >>> access_token_url = 'https://api.twitter.com/oauth/access_token'
        >>> redirect_response = 'https://127.0.0.1/callback?oauth_token=yydoxv4579ua&oauth_token_secret=vgohlcv064243&oauth_verifier=u65p1558844'
        >>> oauth_session = OAuth1Session('client-key', client_secret='secret')
        >>> oauth_session.parse_authorization_response(redirect_response)
        {
            'oauth_token: 'qeueke3092h',
            'oauth_token_secret: 'ygtgvfc785267',
            'oauth_verifier: 'n08a3072322',
        }
        >>> oauth_session.fetch_access_token(access_token_url)
        {
            'oauth_token': 'mle6g4010egqufje',
            'oauth_token_secret': '1zuuaunz09q00ybtyjd',
        }
        """
        if verifier:
    ...
    def parse_authorization_response(self, url):
        ...
        >>> redirect_response = 'https://127.0.0.1/callback?oauth_token=ywmail0887yi&oauth_token_secret=igxkbfk786417&oauth_verifier=w79r6429300'
        >>> oauth_session = OAuth1Session('client-key', client_secret='secret')
        >>> oauth_session.parse_authorization_response(redirect_response)
        {
            'oauth_token: 'psxtud5335z',
            'oauth_token_secret: 'psnwqyf380622',
            'oauth_verifier: 's52r0003072',
        }
        """
