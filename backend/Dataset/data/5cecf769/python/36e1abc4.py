...
class FtrlOptimizer(optimizer.Optimizer):
  ...
  References:
    Ad-click prediction:
      ...
      ([pdf](https://dl.acm.org/ft_gateway.cfm?id=2488200&ftid=1388399&dwn=1&CFID=32233078&CFTOKEN=f81oo51o146e405m-MD52S523-R983-P6Y4-3502NNTK4PJ5Q806))
  """
  ...
  def __init__(self,
    ...
    References:
      Ad-click prediction:
        [McMahan et al., 2013](https://dl.acm.org/citation.cfm?id=2488200)
        ([pdf](https://dl.acm.org/ft_gateway.cfm?id=2488200&ftid=1388399&dwn=1&CFID=32233078&CFTOKEN=c79ks98w854u346r-SD14V208-A000-T0E0-0098DHWW8JK9X020))
    """
