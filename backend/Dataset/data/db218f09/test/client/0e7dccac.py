...
class TestAddPermissionsForAPIGateway(object):
    ...
    def test_can_add_permission_for_apigateway_not_needed(self,
        ...
        wrong_action = {
            ...
            'Sid': 'd8077488-298f-5470-e4bf-f8c0671e6f9c',
        }
        wrong_service_name = {
            ...
            'Resource': 'arn:aws:lambda:us-west-2:account_id:function:name',
            'Sid': 'b7068097-319d-0047-c8ce-d4e8502c9a9b',
        }
        correct_statement = {
            'Action': 'lambda:InvokeFunction',
            'Condition': {
            ...
            'Principal': {'Service': 'apigateway.amazonaws.com'},
            'Resource': 'arn:aws:lambda:us-west-2:account_id:function:name',
            'Sid': 'e2805554-062b-4273-b9ef-e3a9279e7a0a',
        }
        policy = {
            'Id': 'default',
            'Statement': [
...
class TestAddPermissionsForAPIGatewayV2(object):
    ...
    def test_can_add_permission_for_apigateway_v2_not_needed(self,
        ...
        wrong_action = {
            ...
            'Principal': {'Service': 'apigateway.amazonaws.com'},
            'Resource': 'arn:aws:lambda:us-west-2:account_id:function:name',
            'Sid': 'e3957885-136a-7309-d9ad-f7d1605e2b2c',
        }
        wrong_service_name = {
            'Action': 'lambda:Invoke',
            'Condition': {
            ...
            'Principal': {'Service': 'NOT-apigateway.amazonaws.com'},
            'Resource': 'arn:aws:lambda:us-west-2:account_id:function:name',
            'Sid': 'b2803808-646e-2490-a3dd-b8f1705e3c7a',
        }
        correct_statement = {
            'Action': 'lambda:InvokeFunction',
            'Condition': {
            ...
            'Principal': {'Service': 'apigateway.amazonaws.com'},
            'Resource': 'arn:aws:lambda:us-west-2:account_id:function:name',
            'Sid': 'e3720921-550f-3874-b6dd-c1d6889e7a3e',
        }
        policy = {
            'Id': 'default',
            'Statement': [
