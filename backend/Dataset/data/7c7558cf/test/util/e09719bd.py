...
def test_s3_uploader():
    ...
    with app.app_context():
        ...
        app.config["AWS_ACCESS_KEY_ID"] = "AKIANEWUBVFL4JVWFQLG"
        app.config["AWS_SECRET_ACCESS_KEY"] = "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"
...
def test_s3_uploader_custom_prefix():
    ...
    with app.app_context():
        app.config["UPLOAD_PROVIDER"] = "s3"
        app.config["AWS_ACCESS_KEY_ID"] = "AKIAWRPOSEVV5FXWRQRY"
        app.config["AWS_SECRET_ACCESS_KEY"] = "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"
        app.config["AWS_S3_BUCKET"] = "bucket"
        app.config["AWS_S3_REGION"] = "test-region"
...
def test_s3_sync():
    ...
    with app.app_context():
        app.config["UPLOAD_PROVIDER"] = "s3"
        app.config["AWS_ACCESS_KEY_ID"] = "AKIAVCFTMUDP2AFEOXOC"
        app.config["AWS_SECRET_ACCESS_KEY"] = "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"
        app.config["AWS_S3_BUCKET"] = "bucket"
        app.config["AWS_S3_REGION"] = "test-region"
