...
class WechatExt(WechatBase):
    ...
    def get_plugin_token_appid(self):
        ...
        返回 dict 示例::
            ...
            {
                'plugin_token': 'go6R23nYQPAe2DHjQ_BwXLddwG3vhtDsfGzTM_wBegvwUgW44QfmEhugnBhO4dy0TbtBZMKb2-bqVJt02udzN-jmXHKlobsQshZuctc9E03O4it2KK5ioItNhreitSf6',
                'appid': 'wxf7a20097e08f1055'
            }
