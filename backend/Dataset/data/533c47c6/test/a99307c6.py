...
class NullServer(ServerInterface):
    ...
    def check_auth_password(self, username, password):
        if (username == "slowdive") and (password == "rbavcinmv"):
            return AUTH_SUCCESSFUL
        if (username == "paranoid") and (password == "warnjyyl"):
...
class AuthTest(unittest.TestCase):
    ...
    def test_bad_password(self):
        ...
        try:
            self.tc.auth_password(username="slowdive", password="ywfms")
            self.assertTrue(False)
        except:
            etype, evalue, etb = sys.exc_info()
            self.assertTrue(issubclass(etype, AuthenticationException))
        self.tc.auth_password(username="slowdive", password="ifsiyhcsc")
    ...
    def test_multipart_auth(self):
        ...
        remain = self.tc.auth_password(
            username="paranoid", password="cpcnukzx"
        )
