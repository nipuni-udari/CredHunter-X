...
class CMEModule:
    ...
    def decrypt_cpassword(self, cpassword):
        ...
        # From MSDN: http://msdn.microsoft.com/en-us/library/3f82ccf5-f198-5e19-2d41-8b5ef67df4dd%28v=PROT.13%29#endNote2
        key = unhexlify('2b4958b8ddd13cf9beb97141082cfed8e155a101bb287523214b81b623c54b3d')
