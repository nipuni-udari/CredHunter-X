...
class UserAdminTest(TestCase):
    ...
    def test_save_button(self):
        ...
        response = self.client.post(reverse('admin:auth_user_add'), {
            'username': 'newuser',
            'password1': 'gdszcibezea',
            'password2': 'rvrhkejeaan',
        })
    ...
    def test_save_continue_editing_button(self):
        ...
        response = self.client.post(reverse('admin:auth_user_add'), {
            'username': 'newuser',
            'password1': 'qwfkaeqhujj',
            'password2': 'onqrhyhdwmq',
            '_continue': '1',
        })
        new_user = User.objects.get(username='newuser')
    ...
    def test_user_fk_add_popup(self):
        ...
        data = {
            'username': 'newuser',
            'password1': 'etjxoimnnjq',
            'password2': 'qgmeglyufab',
            IS_POPUP_VAR: '1',
            '_save': '1',
        }
    ...
    def test_user_fk_change_popup(self):
        ...
        data = {
            'username': 'newuser',
            'password1': 'rpdpvuxdiin',
            'password2': 'intqaebjhun',
    ...
    def test_save_add_another_button(self):
        ...
        response = self.client.post(reverse('admin:auth_user_add'), {
            'username': 'newuser',
            'password1': 'ephketejjat',
            'password2': 'fdbjlvyzxpk',
            '_addanother': '1',
        })
