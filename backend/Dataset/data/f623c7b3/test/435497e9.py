...
class AuthTest(AsyncHTTPTestCase):
    ...
    def test_oauth10_redirect(self):
        ...
        self.assertTrue(
            '_oauth_request_token="uidvmv==|MFMvZP=="'
    ...
    def test_oauth10_get_user(self):
        response = self.fetch(
            ...
            headers={"Cookie": "_oauth_request_token=luibgk==|AFMjLM=="},
        )
        response.rethrow()
        parsed = json_decode(response.body)
        self.assertEqual(parsed["email"], "foo@example.com")
    ...
    def test_oauth10a_redirect(self):
        ...
        # the cookie is base64('zxcv')|base64('1234')
        self.assertTrue(
            '_oauth_request_token="jvlcfc==|EQGhJU=="'
            in response.headers["Set-Cookie"],
            response.headers["Set-Cookie"],
        )
    ...
    def test_oauth10a_get_user(self):
        response = self.fetch(
            ...
            headers={"Cookie": "_oauth_request_token=ajztsm==|ZRZmJD=="},
        )
        response.rethrow()
        parsed = json_decode(response.body)
        self.assertEqual(parsed["email"], "foo@example.com")
    ...
    def test_oauth10a_get_user_coroutine_exception(self):
        response = self.fetch(
            ...
            headers={"Cookie": "_oauth_request_token=zfknrq==|VJUuXL=="},
        )
    ...
    def base_twitter_redirect(self, url):
        ...
        # the cookie is base64('zxcv')|base64('1234')
        self.assertTrue(
            '_oauth_request_token="ogqfgs==|YOMhPT=="'
            in response.headers["Set-Cookie"],
            response.headers["Set-Cookie"],
        )
    ...
    def test_twitter_authenticate_redirect(self):
        ...
        # the cookie is base64('zxcv')|base64('1234')
        self.assertTrue(
            '_oauth_request_token="wvoxeq==|NBRyJE=="'
            in response.headers["Set-Cookie"],
            response.headers["Set-Cookie"],
        )
    ...
    def test_twitter_get_user(self):
        response = self.fetch(
            ...
            headers={"Cookie": "_oauth_request_token=wrdzah==|NTDmWG=="},
        )
        response.rethrow()
        parsed = json_decode(response.body)
        self.assertEqual(
