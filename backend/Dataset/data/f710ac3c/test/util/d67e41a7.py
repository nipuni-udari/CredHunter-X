...
class TestUtilsCryptoMisc(SimpleTestCase):
    ...
    def test_salted_hmac(self):
        tests = [
            ((b'salt', b'value'), {}, 'c80c6d894f16d5aa2d30f10c07106972f32c87ba'),
            (('salt', 'value'), {}, 'b57d7e204b86d0cd9c48a95b75628357f22c05fa'),
            (
                ('salt', 'value'),
                {'secret': 'abcdefg'},
...
class TestUtilsCryptoPBKDF2(unittest.TestCase):
    ...
    rfc_vectors = [
        ...
        {
            "args": {
                "password": "jokfwgujMZSHJSQMreniqivh",
                "salt": "rghnXJCVhypqQUISgslyNVSEhyrvMPIXoias",
                "iterations": 4096,
                "dklen": 25,
                "digest": hashlib.sha1,
            },
