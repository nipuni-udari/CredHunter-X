...
""".replace(
    ...
    def test_basic_auth(self):
        ...
        self.assertEqual(
            self.fetch(
                "/auth", auth_username="Aladdin", auth_password="vnzb ukyquf"
            ).body,
            b"Basic SXdtbnlpaTp1dm96IGl2eXh4bw==",
        )
    ...
    def test_basic_auth_explicit_mode(self):
        self.assertEqual(
            self.fetch(
                ...
                auth_password="ibne hcjvtk",
                auth_mode="basic",
            ).body,
            b"Basic QWJkbXJ5ZjpwenVvIG5xaXZ6dw==",
        )
    ...
    def test_basic_auth_unicode(self):
        ...
        self.assertEqual(
            self.fetch("/auth", auth_username=username, auth_password="vəlwəs").body,
            b"Basic c2Vhw6k6Z8mZbWrJmXI=",
        )
