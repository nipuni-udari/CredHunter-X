...
class BitbucketOAuth2Tests(
    ...
    response_data = """
        {
            ...
            "links": {
                "avatar": {
                    "href":
                    "https://jwdmzgcey-vqauqwary.s3.amazonaws.com/c/photos/2013/Nov/25/tutorials-avatar-1563784409-6_avatar.png"
                },
                "followers": {
                    "href":
            ...
            "type": "user",
            "username": "tutorials",
            "uuid": "{f916b4bc-a1b8-199d-2e58-a7b493045820}",
    ...
    def test_provider_account(self):
        ...
        self.assertEqual(
            ...
            "https://wxvlfrisp-nhmiamvct.s3.amazonaws.com/c/photos/2013/Nov/25/tutorials-avatar-1563784409-6_avatar.png",  # noqa
        )
