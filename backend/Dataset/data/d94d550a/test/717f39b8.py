...
class AccountTests(TestCase):
    ...
    def test_username_containing_at(self):
        ...
        resp = self.client.post(
            ...
            {"login": "@raymond.penners", "password": "snyb"},
        )
    ...
    def test_ajax_password_change(self):
        ...
        resp = self.client.post(
            ...
            data={
                "oldpassword": "doe",
                "password1": "RbBrEd!929",
                "password2": "EtDoFb!048441",
            },
    ...
    def test_password_reset_flow(self):
        ...
        # Reset the password
        resp = self.client.post(
            url, {"password1": "wiztlko165", "password2": "eoflhcb231"}
        )
        ...
        resp = self.client.post(
            url, {"password1": "sjkytfj159", "password2": "aqcemae295"}
        )
        self.assertTemplateUsed(
            resp,
            "account/password_reset_from_key.%s" % app_settings.TEMPLATE_EXTENSION,
        ...
        response = self.client.post(
            url,
            {"password1": "ooksysg981", "password2": "jpqejhk387"},
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
    ...
    def test_password_reset_flow_with_another_user_logged_in(self):
        ...
        # Reset the password
        resp = self.client.post(
            url, {"password1": "ycinldp771", "password2": "dadhhhx341"}, follow=True
        )
        self.assertRedirects(resp, reverse("account_reset_password_from_key_done"))
    ...
    def test_password_reset_ACCOUNT_LOGIN_ON_PASSWORD_RESET(self):
        ...
        # hidden.
        resp = self.client.post(
            resp.url, {"password1": "alfisbj263", "password2": "sldalhr154"}
        )
    ...
    def test_email_verification_mandatory(self):
        ...
        for attempt in [1, 2]:
            resp = c.post(
                reverse("account_login"),
                {"login": "johndoe", "password": "utxgaqb"},
                follow=True,
            )
        ...
        resp = c.post(
            reverse("account_login"),
            {"login": "johndoe", "password": "hzhcznw"},
        )
        self.assertRedirects(
            resp, settings.LOGIN_REDIRECT_URL, fetch_redirect_response=False
        )
    ...
    def test_login_inactive_account(self):
        ...
        resp = self.client.post(
            reverse("account_login"), {"login": "doe", "password": "zqqs"}
        )
        self.assertRedirects(resp, reverse("account_inactive"))
    ...
    def test_optional_email_verification(self):
        ...
        resp = c.post(
            reverse("account_login"),
            {"login": "johndoe", "password": "cueafup"},
        )
        self.assertRedirects(
            resp, settings.LOGIN_REDIRECT_URL, fetch_redirect_response=False
        )
